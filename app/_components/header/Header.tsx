...
export const Header = () => (
  <header className="header">
    ...
    <nav className="header__nav">
      <span className="header__text-nav">Eduardo Berzunza</span>
      <div className="header__links-box">
        <a href="#wave">Inicio</a>
        <a href="#wave">Nosotros</a>
        <a href="#wave">Proyectos</a>
        <a href="#wave">Testimonios</a>
        <a href="#wave">Contacto</a>
      </div>
      <a href="#wave">Blog</a>
    </nav>
